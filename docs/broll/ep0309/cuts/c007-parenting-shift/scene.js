export function mount(root){
  ...
  wrap.innerHTML=`
    ...
    <div id="card" style="position:relative;max-width:min(980px,84vw);padding:24px 28px;border-radius:18px;border:1px solid rgba(255,255,255,.18);background:linear-gradient(180deg,rgba(255,255,255,.07),rgba(255,255,255,.02));backdrop-filter:blur(4px);font-family:Inter, Pretendard, 'Noto Sans KR', system-ui, sans-serif;color:#eef2f7;opacity:0;transform:translateY(14px)">
