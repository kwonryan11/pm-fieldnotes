export function mount(root){
  ...
  wrap.innerHTML=`
    ...
    <div id="flow" style="position:absolute;left:7%;right:7%;bottom:24%;height:56px;border-radius:16px;border:1px solid rgba(255,179,71,.26);background:linear-gradient(180deg,rgba(255,179,71,.10),rgba(255,255,255,.02));backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:space-between;padding:0 18px;font-family:Inter, Pretendard, 'Noto Sans KR', system-ui, sans-serif;color:#eef2f7;opacity:0;transform:translateY(10px)">
